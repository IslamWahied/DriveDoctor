  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: Text("${carModel.carBrandName} Model ${carModel.carModel}",
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar(
             backgroundColor: Colors.black,
            floating: true,
            expandedHeight: 325.0.h,
leading: const SizedBox(),

            flexibleSpace: FlexibleSpaceBar(

              background: BlocConsumer<HomeCubit, HomeState>(
                builder: (context, state) {
                  ...
                  var getDifferenceBetweenKilometers = getDifferenceBetweenTwoNumbers(
                      firstNumber: carModel.carKilometers,
                      secondNumber: lisServiceModel.lastServiceKilometersMade);
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    serviceName,
                                    style: TextStyle(
                                        color: Colors.grey[200], fontSize: 30.w),
                                  ),
                                  SizedBox(width: 10.w),
                                  Image.asset(
                              ...
                              children: [
                                ...
                                Text(
                                  servicePercentage == 0
                                      ...
                                      : "$getDifferenceBetweenKilometers km left",
                                  style: TextStyle(
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Padding(
                                  ...
                                  child: Text(
                                    "History",
                                    style: TextStyle(color: Colors.grey[200], fontSize: 14.w),
                                  ),
                                ),
                              ),
                            ),
  ...
  child:   Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Row(
          children: [
            Text(homeCubit.listServiceHistoryModel.fold<double>(
                0.0, (previousValue, element) => previousValue + element.cost).toString(),style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w500),),
            ...
            const Icon(Icons.monetization_on,color: Colors.yellow,)
                          ...
                          Expanded(
                            child: ListView.separated(
                                ...
                                itemCount:  homeCubit.listServiceHistoryModel.length,
                                separatorBuilder: (context, state) =>
                                const SizedBox(height: 10),
                                itemBuilder: (context, index) {
                                  return
                                    ServiceHistoryCard(
                                      serviceHistoryModel: homeCubit.listServiceHistoryModel[index],);
                                }),
                          )
                      ],
                    ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10,),
                      Text(
                        widget.serviceHistoryModel.newServiceKilometersMade.toString(),
                        style: const TextStyle(color: Colors.white),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10,),
                          Text(
                              convertToDateString(widget.serviceHistoryModel.createdDate.toString())  ,
                            style: const TextStyle(color: Colors.white),
                          ),
                        ],
                      ),
const SizedBox(width: 25,),
                      const Icon(Icons.arrow_downward,color: Colors.white,size: 17,),
                    ],
                  )
                ],
              ),
              ...
              AnimatedCrossFade(
                ...
                secondChild: Text(
                  ...
                  textAlign: isArabic(text:widget.serviceHistoryModel.detail )?TextAlign.right:TextAlign.left,
                  textDirection: isArabic(text:widget.serviceHistoryModel.detail )?TextDirection.rtl:TextDirection.ltr,
                ),
